...
export default function TodoList(){
    const[tasks, setTasks] = useState([
        ...
        {id: 2, text: "Midterm paper for Art History 130", duedate: "October 25, 2024", priority: 2, completed: false, },
        {id: 3, text: "Study lecture slides for CS 181 midterm", duedate: "October 30, 2024", priority: 1, completed: false, },
